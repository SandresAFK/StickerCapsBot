...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "ea_prompt": {
        "ru": "У тебя {energy} энергии. Присылай стикеры — каждый добавит новую фишку за 1 энергию.\nОдин стикер несколько раз = больше энергии на этой фишке.\nНажми «Подтвердить» когда готово.",
        "en": "You have {energy} energy. Send stickers — each adds a new chip for 1 energy.\nSame sticker multiple times = more energy on that chip.\nTap \"Confirm\" when ready.",
    },
    "ea_progress": {"ru": "Принято {count} из {max}. Пришли ещё или подтверди.", "en": "Collected {count} of {max}. Send more or confirm."},
    "ea_full": {"ru": "Набрано {max} стикеров — энергия израсходована. Нажми «Подтвердить».", "en": "Collected {max} stickers — energy used up. Tap \"Confirm\"."},
