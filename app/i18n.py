...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "choose_chips_same_energy": {"ru": "Выберите фишки на нужные очки.", "en": "Choose chips matching the required points."},
    ...
    "daily_energy": {"ru": "Ежедневные очки: ⚡️ {energy}/3", "en": "Daily points: ⚡️ {energy}/3"},
    "daily_energy_spend": {"ru": "Получи фишки! на {energy} очка!!! ⚡️{energy}", "en": "Get chips! for {energy} pts!!! ⚡️{energy}"},
    "decline": {"ru": "Отказаться", "en": "Decline"},
    "declined": {"ru": "Отклонено.", "en": "Declined."},
        "deselect_all": {"ru": "❌ Снять выделение", "en": "❌ Deselect all"},
    "draw_label": {"ru": "Ничья", "en": "Draw"},
    ...
    "energy_depleted": {"ru": "Очки закончились.", "en": "No points left."},
    "energy_full": {"ru": "Очки: {energy}/{max_energy}", "en": "Points: {energy}/{max_energy}"},
    "energy_menu_prompt": {
        "ru": "Прокачайте существующие фишки или добавьте новые.",
        "en": "Upgrade existing chips or add new ones.",
    },
    "energy_restored": {
        "ru": "Очки восстановились до 3. Можешь получить новые фишки в меню очков.",
        "en": "Points have been restored to 3. You can get new chips in the points menu.",
    },
    "equal_energy_needed": {
        "ru": "Общие очки ваших фишек должны быть равны очкам соперника.",
        "en": "Your chips' total points must match your opponent's points.",
    },
    ...
    "you_label": {"ru": "(ты)", "en": "(you)"},
    "versus": {"ru": "против", "en": "vs"},
    "trophies_section": {"ru": "Трофеи", "en": "Trophies"},
    "losses_section": {"ru": "Потери", "en": "Losses"},
    "leaderboard": {"ru": "🏆 Рейтинг", "en": "🏆 Leaderboard"},
    "leaderboard_header": {"ru": "🏆 Топ игроков\n", "en": "🏆 Top Players\n"},
    "leaderboard_empty": {"ru": "Пока нет игроков.", "en": "No players yet."},
    "loading": {"ru": "Подождите, идёт загрузка…", "en": "Please wait, loading..."},
    "matchmaking": {"ru": "⚔️ Найти соперника", "en": "⚔️ Find opponent"},
    "mm_searching": {"ru": "🔍 Ищу соперника... {count}", "en": "🔍 Finding opponent... {count}"},
    "mm_found": {"ru": "✅ Соперник найден: {name}!", "en": "✅ Opponent found: {name}!"},
    "mm_your_roll": {"ru": "🎳 Твой бросок:", "en": "🎳 Your roll:"},
    "mm_bot_roll": {"ru": "🎳 Бросок {name}:", "en": "🎳 {name}'s roll:"},
    "mm_rematch": {"ru": "⚔️ Реванш", "en": "⚔️ Rematch"},
    "start_mm": {"ru": "🔍 Найти! (⚡️{energy})", "en": "🔍 Find! (⚡️{energy})"},
    "mm_cancel": {"ru": "Отмена поиска", "en": "Cancel search"},
    "need_3_stickers": {"ru": "Нужно 3 стикера.", "en": "You need 3 stickers."},
    "need_choose_same_energy": {
        "ru": "Нужно выбрать фишки на те же очки.",
        "en": "You need to choose chips with the same points.",
    },
    "need_sticker": {"ru": "Нужен стикер.", "en": "A sticker is required."},
    "no_chips": {"ru": "Фишек нет.", "en": "No chips."},
    "no_chips_and_energy": {"ru": "У вас нет очков и фишек.\n{energy_text}", "en": "You have no points and no chips.\n{energy_text}"},
    "no_chips_notify": {
        "ru": "У вас нет фишек.\nВы можете получить новые фишки через {time_left}.\nВы получите уведомление, когда очки восстановятся.",
        "en": "You have no chips.\nYou can get new chips in {time_left}.\nYou will receive a notification when points are restored.",
    },
    ...
    "no_energy": {"ru": "Нет очков.", "en": "No points."},
    "no_energy_wait": {"ru": "Нет очков. Новые очки появятся через {time_left}.", "en": "No points. New points will appear in {time_left}."},
    "no_players": {"ru": "Нет игроков.", "en": "No players."},
    "noop_hint": {"ru": "Выберите фишки на нужные очки.", "en": "Choose chips matching the required points."},
    "not_enough_energy": {"ru": "Не хватает очков.", "en": "Not enough points."},
    "nothing_to_apply": {"ru": "Нечего применять.", "en": "Nothing to apply."},
    "notification_when_energy_restored": {
        "ru": "Вы получите уведомление, когда очки восстановятся.",
        "en": "You will receive a notification when points are restored.",
    },
    ...
    "reset_confirm": {"ru": "Да, сбросить", "en": "Yes, reset"},
        "select_all": {"ru": "✅ Выделить все", "en": "✅ Select all"},
    ...
    "send_sticker_to_add": {"ru": "Пришли стикер: добавлю фишку (+1) за 1 очко.", "en": "Send a sticker: I'll add a chip (+1) for 1 point."},
    "ea_prompt": {
        "ru": "У тебя {energy} очков. Присылай стикеры — каждый добавит новую фишку за 1 очко.\nОдин стикер несколько раз = больше очков на этой фишке.\nНажми «Подтвердить» когда готово.",
        "en": "You have {energy} points. Send stickers — each adds a new chip for 1 point.\nSame sticker multiple times = more points on that chip.\nTap \"Confirm\" when ready.",
    },
    "ea_progress": {"ru": "Принято {count} из {max}. Пришли ещё или подтверди.", "en": "Collected {count} of {max}. Send more or confirm."},
    "ea_full": {"ru": "Набрано {max} стикеров — очки израсходованы. Нажми «Подтвердить».", "en": "Collected {max} stickers — points used up. Tap \"Confirm\"."},
    "ea_confirm_btn": {"ru": "✅ Подтвердить ({count}/{max})", "en": "✅ Confirm ({count}/{max})"},
    "ea_done": {"ru": "Фишки добавлены!", "en": "Chips added!"},
    ...
    "stats_header": {"ru": "📊 Игроков: {players}  |  Дуэлей: {duels}  |  Матчей: {mm}  |  Очков: {points}\n", "en": "📊 Players: {players}  |  Duels: {duels}  |  MM: {mm}  |  Points: {points}\n"},
